package com.sadad.springbootcource.ecommerce.rest;
...
public class CustomerResource {
    ...
    @GetMapping("/getCustomerByEmailNamedParam/{email}")
    public ResponseEntity<List<Customer>> getCustomerByEmailNamedParam(@RequestParam String email) {
        return ResponseEntity.ok(customerService.getCustomerByEmailNamedParam(email));
    }
